  ...
  return {
    ...
    RecommendationsCard:{
      ...
      Treading : [
        ...
        {img:"surfing_image.png","Event_ID": 10006,heartIcon:true,  vibetext:'Active & Energizing', vibeicon:'joy.svg', rank:"one.svg",  date:"Dec 10-29", title:"Surfing", desc:"AED 1800 per person"},
        {img:"yacht.jpg","Event_ID": 10007, heartIcon:true, vibetext:'Vibrant & Social', vibeicon:'joy.svg', rank:"two.svg",  date:"Dec 10-29", title:"Jazz Music", desc:"AED 1800 per person"},
        {img:"dive.jpg","Event_ID": 10008, heartIcon:true,  vibetext:'Glamorous & Grand', vibeicon:'overwhelmed.svg', rank:"three.svg",  date:"Dec 10-29", title:"Sweet Wonderland", desc:"AED 1800 per person"},
        {img:"kite_surfing.png","Event_ID": 10009 ,heartIcon:true,  vibetext:'Active & Energizing',  vibeicon:'overwhelmed.svg', rank:"four.svg",  date:"Dec 10-29", title:"Kite Surfing", desc:"AED 1800 per person"},
    ]
    },
    AttendEventCard:{
