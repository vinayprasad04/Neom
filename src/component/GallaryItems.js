...
const GallaryItems = (props) =>{
    ...
    const totalItem = imagesGallery.Event_Images.length
    return(
    <div className="eventDetails__grid">
              <div className="eventDetails__grid--col grid__box">
                {imagesGallery.Event_Images.slice(0,4).map((item, index) => {
                  return (
              ...
              <div className="eventDetails__grid--col">
                <img
                  src={process.env.PUBLIC_URL + "./../img/" + imagesGallery?.Event_Images[totalItem-1].img}
                  alt=""
