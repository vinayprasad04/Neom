...
const HeaderAlert = ({headerAlert, setHeaderAlert}) =>{
    const onCancelAlert= ()=>{
    ...
    return(
        <div className={`popup ${headerAlert ? "active":"" }`}>
            ...
            <div className="popup__actions">
                <Link to={'/recommendation'} className={"popup__btn"} onClick={onCancelAlert}>
                    I want to see
                </Link>
            ...
            <div className="popup__close" onClick={onCancelAlert}>
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88" enable-background="new 0 0 122.881 122.88">
                    <g>
                ...
                <nav className="header__menu">
                    <ul className="header__nav">
                        ...
                        <li className="header__nav__item header__nav__item--notifications">
                            ...
                            <HeaderAlert headerAlert={headerAlert} setHeaderAlert={setHeaderAlert}/>
                        </li>
